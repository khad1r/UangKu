  ...
  <div class="row">
    ...
    <div class="col-sm-8 col-lg-3">
      <div class="d-flex justify-content-center mt-5 mb-3">
        <h2 class="fw-bold text-secondary">Catat Transaksi <i class="far fa-edit"></i></h2>
      </div>
      <hr class="border-2">
    </div>
    <div class="col"></div>
  ...
  <form id="form" method="post" class="row" enctype="multipart/form-data">
    <div class="col-lg-8" id="main-group">
      ...
      <div class="p-3 mb-4 border-bottom border-top border-2 border-primary form-check form-switch d-flex justify-content-between ps-0" style="font-size: .75em;font-weight: 600;">
        ...
        <input class="form-check-input hide-group" type="checkbox" id="rutin" name="rutin" disabled="true" required>
    ...
    <div class="col-lg-4" id="summary-group">
      ...
      <div class="form-group">
        ...
        <input type="file" placeholder="Attachment" class="form-control" accept="image/jpeg, image/png, image/jpg, application/pdf" name="attachment" />
...
<script>
  ...
  const rekeningSelectFormater = (d) => {
    ...
    option['html'] = (d.isAsing) ?
      `<span class="d-flex justify-content-between w-100 me-2"><b>${d.nama.toUpperCase()}</b><span>${formattedNumber.format(d.saldo_asing)},- ${d.nominal_asing}</span></span>` :
      `<span class="d-flex justify-content-between w-100 me-2"><b>${d.nama.toUpperCase()}</b><span>Rp. ${formattedNumber.format(d.saldo)},-</span></span>`
    return option
  }
